      ...
      <section class="w-full max-w-3xl min-h-screen my-0 mx-auto flex items-center p-6 flex-wrap md:flex-nowrap">
        <article class="w-full mb-5">
          ...
          <ul class="block leading-snug mt-4">
            <li>
              <ActionLink href=":!i18n_link0:0!:">:!i18n_link0:1!:</ActionLink>
            </li>
            <li>
              <ActionLink href=":!i18n_link1:0!:">:!i18n_link1:1!:</ActionLink>
            </li>
            <li>
              <ActionLink href=":!i18n_link2:0!:">:!i18n_link2:1!:</ActionLink>
            </li>
            <li>
              <ActionLink href=":!i18n_link3:0!:">:!i18n_link3:1!:</ActionLink>
            </li>
            <li>
              <ActionLink href=":!i18n_link4:0!:">:!i18n_link4:1!:</ActionLink>
            </li>
          </ul>
